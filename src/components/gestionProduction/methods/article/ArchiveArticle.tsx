...
const ArchiverArticle = ({ id }: ArchiveArticlePorp, ref: Ref<void>) => {
  ...
  // const archiveTemp = () => {
  //   axios
  //     .patch("http://localhost:1000/api/v1/articlees/" + id0 + "/archive")
  //     .then(() => { });
  // };
  return (
    <>
...
export default forwardRef(ArchiverArticle);